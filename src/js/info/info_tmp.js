$(document).ready(function() {
  ...
  $("#contents .category > ul > li").on("click", function() {
    ...
    $(".con_table_wrap .write > li .cont").css("display", "none");
    $(".con_table_wrap .write > li .cont").eq(thIdx).css("display", "block");
  ...
  /*계약 신청인 정보 동일 체크박스*/
  $(".con_table_wrap .write #mng + span, .con_table_wrap .write #les + span").on('click', function() {
    $(this).toggleClass("on");
    var isChecked = $(this).prev().prop("checked");
    isChecked = !isChecked;
    $(this).prev().prop("checked", isChecked);
  });
  $(".con_table_wrap .write #mng + span + label, .con_table_wrap .write #les + span + label").on('click', function() {
